...
#pragma config(Sensor, dgtl10, bumpSwitch_1,   sensorTouch)
#pragma config(Sensor, dgtl11, bumpSwitch_2,   sensorTouch)
#pragma config(Sensor, dgtl12, bumpSwitch\_3,   sensorTouch)
